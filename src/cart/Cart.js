        ...
        <div className="card">
          ...
          <div className="card-content">
            ...
            <div className="quantity-controls">
              ...
              <button onClick={() => handleIncreaseQuantity(product._id)} className="btn-small green">+</button>
            </div>
            <button onClick={() => handleRemoveFromCart(product._id)} className="btn-small red">Remover do Carrinho</button>
          </div>
        </div>
      </div>
    ));
